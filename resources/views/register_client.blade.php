                ...
                <div class="p-6 text-gray-900">
                        ...
                        <form  method="POST" action="{{ route('client.register') }}">
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input id="address" class="block mt-1 w-full" type="text" name="address" :value="old('address')" required autocomplete="off" />
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input id="neighborhood" class="block mt-1 w-full" type="text" name="neighborhood" :value="old('neighborhood')" required autocomplete="off" />
